  ...
  return (
    <div className="min-h-[60vh] flex flex-col-reverse gap-16 lg:gap-0 lg:flex-row items-center justify-between">
      <div className="space-y-10 text-center lg:text-left">
        ...
        <Link
          href={"mailto:mailoctavemusic@gmail.com"}
      ...
      <div className="w-80 h-72 space-y-3 rotate-[30deg]  relative">
        ...
        <div className="absolute bottom-5 sm:bottom-14 left-0 sm:-left-10 " style={{transform: 'rotate(-30deg)'}}>
